...
<label>Name</label>
<input type="text" name="name" value="<%=sb.getName()%>"><br>
<label>E-Mail</label>
<input type="email" name="email" value="<%=sb.getEmail()%>"><input type="button" value="인증메일 발송" onclick="sendmail()"><br>
<label></label>
